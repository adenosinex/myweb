...
CONFIG = {
    "db_path": r"C:\Users\xin-a\Videos\core_app\db\videos.db",

    "src_base_dir": r"\\One\e\buffe",

    "heart_dir": r"\\One\e\move\new",

    "bad_dir": r"\\One\d\move video\bad",
}
